...
bullet_surf = pygame.image.load(join('images', 'laser.png')).convert_alpha()
meteor_surf = pygame.image.load(join('images', 'meteor.png')).convert_alpha()
star_surf = pygame.image.load(join('images', 'star.png')).convert_alpha()

# Load SFX
meteor_explosion = pygame.mixer.Sound("sounds/explosion (9).wav")
meteor_explosion.set_volume(0.6)
player_hit = pygame.mixer.Sound("sounds/hitHurt.wav")
player_shoot = pygame.mixer.Sound("sounds/laserShoot.wav")
player_move = pygame.mixer.Sound("sounds/tone.wav")
player_move.set_volume(0.14)
player_death = pygame.mixer.Sound("sounds/synth.wav")
